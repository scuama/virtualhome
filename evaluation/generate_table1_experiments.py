...
def source_path(sample_id: str) -> Path:
    ...
    return CONFIGS / folder / f"{sample_id}.json"
...
def main() -> None:
    ...
    if not args.validate_only:
        ...
        write_json(OUTPUT / "manifest.json", build_manifest(configs))
    print("Validated 57 Table 1 configs: scale=15, instruction_type=21, dynamic=21")
