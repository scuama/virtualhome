...
5. COUNTER-INTUITIVE PHYSICS (CRITICAL): The `sink` is NOT a container in this physical engine, it is a flat surface! You absolutely CANNOT `[open]` a sink and you CANNOT `[putin]` to a sink. If you need to place something in the sink, you MUST output exactly `[putback] <object> <sink>`, otherwise the physics engine will reject your action.
